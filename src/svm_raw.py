...
from raw_pixels import X_train, y_train, X_val, y_val, X_test, y_test

MODEL_PATH = Path("../data/best_svm_raw.pkl")
...
for i, C in enumerate(C_values):
    for j, gamma in enumerate(gamma_values):
        ...
        print(f"\n[{combo}/{total}] Training SVM (raw pixels) — C={C}, gamma={gamma}...")
